...
namespace Cardboard {
  ...
  public static partial class CardboardDeviceReflection {
    ...
    static CardboardDeviceReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            "ChZjYXJkYm9hcmRfZGV2aWNlLnByb3RvEgljYXJkYm9hcmQi7gMKDERldmlj",
            "ZVBhcmFtcxIOCgZ2ZW5kb3IYASABKAkSDQoFbW9kZWwYAiABKAkSHwoXc2Ny",
            "ZWVuX3RvX2xlbnNfZGlzdGFuY2UYAyABKAISGwoTaW50ZXJfbGVuc19kaXN0",
            "YW5jZRgEIAEoAhIpCh1sZWZ0X2V5ZV9maWVsZF9vZl92aWV3X2FuZ2xlcxgF",
            "IAMoAkICEAESUQoSdmVydGljYWxfYWxpZ25tZW50GAsgASgOMi0uY2FyZGJv",
            "YXJkLkRldmljZVBhcmFtcy5WZXJ0aWNhbEFsaWdubWVudFR5cGU6BkJPVFRP",
            "TRIdChV0cmF5X3RvX2xlbnNfZGlzdGFuY2UYBiABKAISIwoXZGlzdG9ydGlv",
            "bl9jb2VmZmljaWVudHMYByADKAJCAhABEkIKDnByaW1hcnlfYnV0dG9uGAwg",
            "ASgOMiIuY2FyZGJvYXJkLkRldmljZVBhcmFtcy5CdXR0b25UeXBlOgZNQUdO",
            "RVQiOAoVVmVydGljYWxBbGlnbm1lbnRUeXBlEgoKBkJPVFRPTRAAEgoKBkNF",
            "TlRFUhABEgcKA1RPUBACIkEKCkJ1dHRvblR5cGUSCAoETk9ORRAAEgoKBk1B",
            "R05FVBABEgkKBVRPVUNIEAISEgoOSU5ESVJFQ1RfVE9VQ0gQA0IvChpjb20u",
            "Z29vZ2xlLmNhcmRib2FyZC5wcm90b0IPQ2FyZGJvYXJkRGV2aWNlSAM="));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          new pbr::FileDescriptor[] { },
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::Cardboard.DeviceParams), global::Cardboard.DeviceParams.Parser, new[]{ "Vendor", "Model", "ScreenToLensDistance", "InterLensDistance", "LeftEyeFieldOfViewAngles", "VerticalAlignment", "TrayToLensDistance", "DistortionCoefficients", "PrimaryButton" }, null, new[]{ typeof(global::Cardboard.DeviceParams.Types.VerticalAlignmentType), typeof(global::Cardboard.DeviceParams.Types.ButtonType) }, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public static pbr::MessageDescriptor Descriptor {
      get { return global::Cardboard.CardboardDeviceReflection.Descriptor.MessageTypes[0]; }
    }
    ...
    private readonly static global::Cardboard.DeviceParams.Types.VerticalAlignmentType VerticalAlignmentDefaultValue = global::Cardboard.DeviceParams.Types.VerticalAlignmentType.Bottom;

    private global::Cardboard.DeviceParams.Types.VerticalAlignmentType verticalAlignment_;
    /// <summary>
    ...
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public global::Cardboard.DeviceParams.Types.VerticalAlignmentType VerticalAlignment {
    ...
    private readonly static global::Cardboard.DeviceParams.Types.ButtonType PrimaryButtonDefaultValue = global::Cardboard.DeviceParams.Types.ButtonType.Magnet;

    private global::Cardboard.DeviceParams.Types.ButtonType primaryButton_;
    /// <summary>
    ...
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public global::Cardboard.DeviceParams.Types.ButtonType PrimaryButton {
    ...
    void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
      ...
      leftEyeFieldOfViewAngles_.WriteTo(ref output, _repeated_leftEyeFieldOfViewAngles_codec);
      if (HasTrayToLensDistance) {
        output.WriteRawTag(53);
        output.WriteFloat(TrayToLensDistance);
      }
      distortionCoefficients_.WriteTo(ref output, _repeated_distortionCoefficients_codec);
      if (HasVerticalAlignment) {
        output.WriteRawTag(88);
        output.WriteEnum((int) VerticalAlignment);
      }
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 88: {
            VerticalAlignment = (global::Cardboard.DeviceParams.Types.VerticalAlignmentType) input.ReadEnum();
            break;
          }
          case 96: {
            PrimaryButton = (global::Cardboard.DeviceParams.Types.ButtonType) input.ReadEnum();
            break;
          }
        }
      }
    ...
    void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 42:
          case 45: {
            leftEyeFieldOfViewAngles_.AddEntriesFrom(ref input, _repeated_leftEyeFieldOfViewAngles_codec);
            break;
          }
          case 53: {
            TrayToLensDistance = input.ReadFloat();
          ...
          case 58:
          case 61: {
            distortionCoefficients_.AddEntriesFrom(ref input, _repeated_distortionCoefficients_codec);
            break;
          }
          case 88: {
            VerticalAlignment = (global::Cardboard.DeviceParams.Types.VerticalAlignmentType) input.ReadEnum();
